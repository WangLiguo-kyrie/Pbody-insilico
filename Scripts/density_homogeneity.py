...
trajectory_dir='/grain/liguo/MYC/IDP-conf-change/Project4_Condensate_reconstitution/Pbody_yeast/condensate-replica1/'
...
np.savetxt('replica1/water_number_voxel.xvg', np.array(number_grid_collect),delimiter='	')
...
ax.hist(number_grid_collect.flatten(),bins=bins_edge,edgecolor='white',density=True,alpha=0.8,color='#3d5a9c')
...
plt.savefig('replica1/water_hist_Voxel8.png',dpi=600,bbox_inches='tight')
plt.show()
